...
import { CheckCircle, Trash2, AlertTriangle, Zap, ShieldX } from 'lucide-react'
import SeverityBadge from './SeverityBadge'
import { acknowledgeAlert, deleteAlert } from '../api/stats'
...
export default function AlertPanel({ alerts = [], onRefresh, isAdmin = false }) {
