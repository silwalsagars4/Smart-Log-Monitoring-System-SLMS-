    ...
    <Layout>
      <div className="p-6">
        ...
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-brand-600/20 to-purple-600/20 border border-brand-500/20 p-6 backdrop-blur-sm">
          <div className="absolute top-0 right-0 -mt-4 -mr-4 w-24 h-24 bg-brand-500 rounded-full mix-blend-multiply filter blur-2xl opacity-20 animate-pulse"></div>
          <div className="absolute bottom-0 left-0 -mb-4 -ml-4 w-24 h-24 bg-purple-500 rounded-full mix-blend-multiply filter blur-2xl opacity-20 animate-pulse" style={{ animationDelay: '1s' }}></div>
          
          <h1 className="text-2xl font-bold text-white flex items-center gap-2">
            <SettingsIcon className="text-brand-400" /> Platform Settings
          </h1>
          <p className="text-slate-400 text-sm mt-1">Manage your account, users, and system configurations.</p>
        </div>
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md transition-all duration-200 flex-1 justify-center
                  ${activeTab === tab.id 
                    ? 'bg-surface-600 text-white shadow-sm glow-brand-sm' 
